...
class DropdownSearch<T> extends StatefulWidget {
  ...
  final Widget? notFoundIndicatorWidget;
...
class DropdownSearchState<T> extends State<DropdownSearch<T>> {
  ...
  Widget _manageSuffixIcons() {
    ...
    return Row(
      ...
      children: <Widget>[
        ...
        IconButton(
          icon: widget.dropdownButtonProps?.icon ?? const Icon(Icons.arrow_drop_down, size: 24),
          ...
          padding: widget.dropdownButtonProps?.padding ?? const EdgeInsets.all(8.0),
          ...
          mouseCursor: widget.dropdownButtonProps?.mouseCursor ?? SystemMouseCursors.click,
  ...
  Widget _selectDialogInstance({double? defaultHeight}) {
    return SelectionWidget<T>(
      ...
      notFoundIndicatorWidget: widget.notFoundIndicatorWidget,
    );
  }
